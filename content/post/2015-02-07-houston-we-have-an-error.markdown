...
most non-trivial programs it's pretty important. This blog discusses
the various types of errors that might occur when writing programs, and how these might be handled. Examples use the `C` programming language.
...
**Read on:** [Houston We Have An Error Part 2]({% post_url 2015-02-16-houston-we-have-an-error-part-2 %})
